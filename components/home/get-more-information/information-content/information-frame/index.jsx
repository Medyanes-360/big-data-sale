  ...
  return (
    <div className="flex flex-col gap-y-3">
      ...
      <div className="flex items-center gap-x-4">
        <ButtonComponent className="text-tertiary800 bg-softedWhite  w-full h-[52px] flex items-center justify-center max-w-[257px] rounded-[9.08px] font-Inter font-medium text-[18.17px] leading-[51.91px]">
          Daha Fazla Bilgi Al
        </ButtonComponent>
        <ButtonComponent className="bg-tertiary800 h-[52px] flex   w-full items-center justify-center max-w-[257px] rounded-[9.08px] font-Inter font-medium text-[18.17px] leading-[51.91px] text-white">
          Hemen Başla
        </ButtonComponent>
      </div>
    </div>
