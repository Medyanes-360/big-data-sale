...
const AdvertisingBox = ({ text, icon, className }) => {
  return (
    <div
      className={`drop-shadow-custom-combined backdrop-blur-custom w-fit h-[36.7px] sm:h-[56.14px] flex items-center justify-center gap-x-2 lg:gap-x-5 px-3 lg:px-5 bg-white-50 border border-solid border-silver-400 rounded-[16px] ${className}`}
    >
