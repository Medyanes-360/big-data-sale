    ...
    <div className="bg-info-pattern font-Inter p-8">
      ...
      <div className="flex flex-col text-center items-center justify-center py-6 gap-4 md:gap-8">
          ...
          <div className="flex md:flex-row flex-col gap-3 w-full md:max-w-[408px] items-center justify-center">
            <ButtonComponent className="border-[1.5px] px-4 border-tertiary400 text-tertiary400 h-10 rounded-lg font-Inter font-medium text-sm sm:!text-[18px] leading-10 !w-full md:!max-w-[198px] tracking-tighter">
              <Link href='/'>Daha Fazla Bilgi Al</Link>
            </ButtonComponent>
            <ButtonComponent className="bg-tertiary400 h-10 px-4 rounded-lg font-Inter font-medium text-sm sm:!text-[18px] leading-10 !w-full md:!max-w-[198px] tracking-tighter text-white-default">
